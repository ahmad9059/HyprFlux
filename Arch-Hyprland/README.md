...
# 💌 ** HyprFlux's Arch - Hyprland Install Script ** 💌

<p align="center">
  <img src="https://raw.githubusercontent.com/HyprFlux/Hyprland-Dots/main/assets/latte.png" width="400" />
</p>

![GitHub Repo stars](https://img.shields.io/github/stars/HyprFlux/Arch-Hyprland?style=for-the-badge&color=cba6f7) ![GitHub last commit](https://img.shields.io/github/last-commit/HyprFlux/Arch-Hyprland?style=for-the-badge&color=b4befe) ![GitHub repo size](https://img.shields.io/github/repo-size/HyprFlux/Arch-Hyprland?style=for-the-badge&color=cba6f7) <a href="https://discord.gg/HyprFlux-tech-world"> <img src="https://img.shields.io/discord/1151869464405606400?style=for-the-badge&logo=discord&color=cba6f7&link=https%3A%2F%2Fdiscord.gg%HyprFlux-tech-world"> </a>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/HyprFlux/Hyprland-Dots/main/assets/latte.png" width="200" />
</p>

<div align="center">
👇 HyprFlux Hyprland-Dots related Links 👇
<br/>
</div>
<div align="center">
<br>
  <a href="https://github.com/ahmad9059/HyprFlux/Hyprland-Dots"><kbd> <br> Hyprland-Dots repo <br> </kbd></a>&ensp;&ensp;
  ...
  <a href="https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/wiki/FAQ"><kbd> <br> FAQ <br> </kbd></a>&ensp;&ensp;
...
<h3 align="center">
	...
	HyprFlux Hyprland-Dotfiles Showcase 
	<img src="https://github.com/ahmad9059/HyprFlux/Telegram-Animated-Emojis/blob/main/Activity/Sparkles.webp" alt="Sparkles" width="38" height="38" />
</h3>
...
- This Repo does not contain Hyprland Dots or configs! Dotfiles can be checked here [`Hyprland-Dots`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots) . During installation, if you opt to copy pre-configured dots, it will be downloaded from that centralized repo.
- Hyprland-Dots use are constantly evolving / improving. you can check CHANGELOGS here [`Hyprland-Dots-Changelogs`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/wiki/Changelogs)
- Since the Hyprland-Dots are evolving, some of the screenshots maybe old
- the wallpaper offered to be downloaded towards the end is from this [`REPO`](https://github.com/ahmad9059/HyprFlux/Wallpaper-Bank)
...
- If you opted to install SDDM theme, here's the [`LINK`](https://github.com/ahmad9059/HyprFlux/simple-sddm-2) which is a modified fork of [`LINK`](https://github.com/Keyitdev/sddm-astronaut-theme)
- If you opted to install GTK Themes, Icons, here's the [`LINK`](https://github.com/ahmad9059/HyprFlux/GTK-themes-icons). This also includes Bibata Modern Ice cursor.
...
- After installation, check [`THIS`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/wiki/Notes_to_remember#--for-nvidia-gpu-users)
...
```bash
sh <(curl -L https://raw.githubusercontent.com/HyprFlux/Arch-Hyprland/main/auto-install.sh)
```
...
```bash
git clone --depth=1 https://github.com/ahmad9059/HyprFlux/Arch-Hyprland.git ~/Arch-Hyprland
cd ~/Arch-Hyprland
chmod +x install.sh
./install.sh
```
...
- Head over to [HyprFlux Hyprland WIKI](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/wiki)

#### 🙋 Got a questions regarding the Hyprland Dots or configurations? 🙋

- Head over to wiki Link [`WIKI`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/wiki)
...
> [!TIP]
> HyprFlux Hyprland has a searchable keybind function via rofi. (SUPER SHIFT K) or right click the `HINTS` waybar button

#### 🔄 switching between Hyprland-git and none Hyprland-git

- you can use my prepared script [`LINK`](https://github.com/ahmad9059/HyprFlux/Arch-Hyprland/tree/main/assets/hyprland-install)
- Readme is also there

#### 🙋 👋 Having issues or questions?

- for the install part, kindly open issue on this repo
- for the Pre-configured Hyprland dots / configuration, submit issue [`here`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/issues)
...
- [`SEE HERE`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/discussions/123#discussion-6035205)
...
- If you want to contribute and/or test the Hyprland-Dotfiles (development branch), [`Hyprland-Dots-Development`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/tree/development)
- Want to contribute on HyprFlux-Hyprland-Dots Click [`HERE`](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/blob/main/CONTRIBUTING.md) for a guide how to contribute
- Want to contribute on This Installer? Click [`HERE`](https://github.com/ahmad9059/HyprFlux/Arch-Hyprland/blob/main/CONTRIBUTING.md) for a guide how to contribute
...
[![Youtube Playlist Thumbnail](https://raw.githubusercontent.com/HyprFlux/screenshots/main/Youtube.png)](https://youtube.com/playlist?list=PLDtGd5Fw5_GjXCznR0BzCJJDIQSZJRbxx&si=iaNjLulFdsZ6AV-t)

## 🥰🥰 💖💖 👍👍👍

[![Stargazers over time](https://starchart.cc/HyprFlux/Arch-Hyprland.svg?variant=adaptive)](https://starchart.cc/HyprFlux/Arch-Hyprland)
