...
- Fixing scripts
  ...
  - `HyprFluxsDotsUpdate.sh` contains a malformed `notify-send` string that crashes the script when no local version is detected.
...
- Fixed: Wallpapers with periods in names truncated
  - https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/pull/873
...
- GameMode.sh / Refresh.sh
  ...
  - Resolves [Issue 870](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/issues/870)
...
[GitHub Discussions](https://github.com/ahmad9059/HyprFlux/Hyprland-Dots/discussions) or
[Through Discord Server](https://discord.gg/HyprFlux-tech-world)
